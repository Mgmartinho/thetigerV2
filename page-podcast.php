...
<div class="section section-border" style="background: linear-gradient(to right, 
									  #000000, /* preto */
									  #003366); /* azul escuro */
		   padding: 50px 15px; /* Ajuste de padding para telas menores */
		   min-height: 400px;
		   color: ;"> <!-- Texto branco -->
	...
	<div class="container" style=" color: white ;">
		...
		<div class="row text-center">
			<div class="col-sm-12 col-md-12 ">
				<div class="feature-box-8 ">
					<div class="media">
						<img src="<?php echo get_template_directory_uri(); ?>/images/podcast1.jpeg"
							style="width:1200px; height: 432px;" alt="Podcast Image" class="img-fluid ">
					</div>
					<div class="body">
						<a href="/courses-single-1" class="title"></a><br>
						<a class="btn btn-warning" href="/courses-single-1">
							Conectando Corações e Fortalecendo Laços
						</a>
					</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-12 col-md-4">
				<img src="<?php echo get_template_directory_uri(); ?>/images/podcasthistorias.jpeg"
					style="width:250px; height: auto;" alt="Podcast Image" class="img-fluid ">
		...
		<div class="row mt-5">
			<div class="col-sm-12 col-md-4 mt-5">
				<img src="<?php echo get_template_directory_uri(); ?>/images/podcastdicas.jpeg"
					style="width:240px; height: auto; padding-left :50px; margin-left: 50px" alt="Podcast Image"
			...
			<div class="col-sm-12 col-md-8 m">
				...
				<p style="font-family: 'Brush Script MT', cursive; font-size: 2.2rem;">
					...
					Cada
					episódio é projetado para fornecer ferramentas que você pode aplicar imediatamente em sua vida.
				</p>
				<hr>
			</div>
		...
		<br>
		<img src="<?php echo get_template_directory_uri(); ?>/images/quest.jpeg"
			style="width: 240px; height: auto; display: block; margin: 0 auto;" alt="Podcast Image"
			class="img-fluid mt-5 img-rounded">
		<br>
		<hr>
		<div class="row">
			<div class="col-sm-12 col-md-12">
				...
				<p class="section-gray" style="font-family: 'Brush Script MT', cursive; font-size: 2.2rem;">
					...
					relacionamento pode ser melhorado com as ferramentas e o apoio certos.
				</p>
				<hr>
				...
				<p class="section-blue" style="font-family: 'Brush Script MT', cursive; font-size: 2.2rem;">
					...
					significativa com aqueles que você ama.
				</p>
				<hr>
			</div>
		</div>
		...
		<br>
		<div class="row text-center pt-5" style="">
			<p>Vamos juntos construir pontes de amor e compreensão. Seja bem-vindo ao nosso podcast de Coaching de
				relacionamento.</p>
		</div>
		<div class="text-center col-sm-12 col-md-12">
			<h4 class="fa fa-play"> </h4>

			<h4 class="fa fa-lightbulb"> </h4>


			<h4 class="fa fa-microphone"></h4>


			<h4 class="fa fa-question-circle"> </h4>
